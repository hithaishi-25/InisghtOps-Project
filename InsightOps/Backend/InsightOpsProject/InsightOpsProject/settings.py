...
SECRET_KEY = 'django-insecure-4(w@e7oe6_ki59b424cv)j2yjxmdqvm-cyk(uc0xrj6k^sm@6)'
...
ROOT_URLCONF = 'InsightOpsProject.urls'
...
WSGI_APPLICATION = 'InsightOpsProject.wsgi.application'
...
# Explicitly allow methods and headers
CORS_ALLOW_METHODS = [
    'GET',
    'POST',
    'PUT',
